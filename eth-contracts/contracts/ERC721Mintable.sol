...
contract Ownable {
    ...
    modifier onlyOwner(){
        require(msg.sender == _owner, "Only contract owner can invoke this.");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Only real address can be owner.");
        require(!newOwner.isContract(), "Only real address can be owner.");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner,"To cannot be the owner of the token.");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner,msg.sender),"Caller should be the owner or approved by the owner.");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!to.isContract() || !_exists(tokenId), "To is invalid address or tokenId already exists.");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == from, "from should be the token owner.");
...
contract GosayirERC721Token is ERC721Metadata{
