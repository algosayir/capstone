...
contract('SquareVerifier', accounts => {
    ...
    it("Test verification with correct proof", async () => {
        ...
        try{
            success = await this.contract.verifyTx.call(
                proof.proof.a,
                proof.proof.b,
                proof.proof.c,
                proof.inputs); 
        ...
        assert.equal(success,true,"Proof is correct but verification was not successful.");
    });
    ...
    it("Test verification with incorrect proof", async () => {
        ...
        assert.equal(success,false,"Proof is incorrect but verification results was true.");
    });
})